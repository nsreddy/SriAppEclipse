 ...
 * selections.
 */
public class MenuItemListActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (findViewById(R.id.menuitem_detail_container) != null) {
			...
			((MenuItemListFragment) getFragmentManager().findFragmentById(
					R.id.menuitem_list)).setActivateOnItemClick(true);
		}

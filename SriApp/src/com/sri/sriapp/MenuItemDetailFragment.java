...
import com.sri.sriapp.dummy.DummyContent;
...
public class MenuItemDetailFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		//	((TextView) rootView.findViewById(R.id.menuitem_detail)).setText(mItem.content);
			((TextView) rootView.findViewById(R.id.menuitem_detail)).setText(DummyContent.EventDetails.get(Integer.parseInt(mItem.id)-1).toString());
		}
